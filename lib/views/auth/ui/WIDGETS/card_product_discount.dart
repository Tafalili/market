...
class card_product_show_discount extends StatelessWidget {
  const card_product_show_discount({
    super.key, required this.image_url, required this.discount_value, required this.Product_name, required this.new_price, required this.old_price, required this.productid,
  });
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: () {context.read<HomeCubit>().favorate(productID: productid);print(productid);}, icon: Icon(Icons.favorite))
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
